        ...
        void Termet_Betolt()
        {
            ...
            for (int i = 0; i < Corvin.termek[akt].Sorok; i++)
            {
                for (int j = 0; j < Corvin.termek[akt].Szekek; j++)
                {
                    ...
                    panel_Terem.Controls.Add(gomb);
                }
            }
            if (akt == 0)
            {
                button_Balra.Visible = false;
                button_Jobbra.Visible = true;
            }
            else if (akt == Corvin.termek.Count - 1)
            {
                button_Balra.Visible = true;
                button_Jobbra.Visible = false;
            }
            else
            {
                button_Balra.Visible = true;
